...
export { default as iconFacebook } from './logo/iconFacebook.svg';
...
export { default as imgCart } from './image/cart.png';
...
export { default as notificationAudioUser } from './audio/notificationUser.mp3';
