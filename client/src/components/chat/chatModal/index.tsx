...
const ChatModal: React.FC<{
    ...
    admin: { admin_name: string; admin_avatar_url: string } | any;
    setUnreadMessages?: (count: any) => void;
}> = ({ conversationId, admin, setUnreadMessages }) => {
                    ...
                    : [
                          {
                              ...
                              senderRole: 'admin',
                              text: 'Bạn yêu cần mình tư vấn gì hông nè!😜',
                              seen: true,
